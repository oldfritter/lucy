...
func (*CaptchaTextimage4) TableName() string {
	return "captcha_textimage"
}

func (captcha *CaptchaTextimage4) Json() string {
...
func (captcha *CaptchaTextimage4) GetWithPaginate(db *gorm.DB, r *util.Response) {
	var results []*CaptchaTextimage4
...
func (captcha *CaptchaTextimage4) Create() {
...
func (captcha *CaptchaTextimage4) Verify(attrs map[string]any) (yes bool) {
	return
}

func (captcha *CaptchaTextimage4) loadBackground(inputPath string) image.Image {
